...
export default function VolunteerRegister() {
  const [form, setForm] = useState({ name: '', email: '', password: '', phone: '', ngoName: '' });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded shadow-md w-full max-w-md">
        <h2 className="text-2xl mb-4">Volunteer Registration</h2>
        ...
        <input name="ngoName" placeholder="NGO Name" onChange={handleChange} required className="w-full p-2 mb-4 border" />
